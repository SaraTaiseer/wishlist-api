...
urlpatterns = [
    ...
    path('items/', api_v.ItemListView.as_view(), name='api-list'),
    path('items/<int:item_id>', api_v.ItemDetailView.as_view(), name='api-detail'),
    path('register/',api_v.Register.as_view(),name='api-register'),
